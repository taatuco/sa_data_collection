...
def set_recomm_text_lang():
    ...
    portf_descr_en = "As per the {product_name} proprietary algorithm, projected profit of up to {display_forecast} for every {account_minimum} {unit} invested is achievable within the next 7 days with the following allocation: {portf_recomm}. The specified portfolio has achieved an aggregated profit of {portf_last_price} {portf_unit} in the last 12 months."
    ...
    "('"+lang_en+"', '"+price_under_200ma_en+"', '"+price_above_200ma_en+"', "+\
     ...
     "'"+rsi_strong_en+"', '"+uptrend_recomm_en+"', '"+downtrend_recomm_en+"', '"+portf_desc_en+"', '"+portf_recomm_buy_en+ "', '"+portf_recomm_sell_en+"')"
