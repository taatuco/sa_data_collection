...
SCHTASKS /Create /SC DAILY /TN SMARTALPHA_SET_DATA_0 /TR %SET_DATA% /RI 0 /ST %SET_DATA_0_TIME_ST% /F
SCHTASKS /Create /SC DAILY /TN SMARTALPHA_SET_DATA_1 /TR %SET_DATA% /RI 0 /ST %SET_DATA_1_TIME_ST% /F
SCHTASKS /Create /SC DAILY /TN SMARTALPHA_SET_DATA_2 /TR %SET_DATA% /RI 0 /ST %SET_DATA_2_TIME_ST% /F
SCHTASKS /Create /SC DAILY /TN SMARTALPHA_SET_DATA_3 /TR %SET_DATA% /RI 0 /ST %SET_DATA_3_TIME_ST% /F
SCHTASKS /Create /SC DAILY /TN SMARTALPHA_SET_DATA_4 /TR %SET_DATA% /RI 0 /ST %SET_DATA_4_TIME_ST% /F
SCHTASKS /Create /SC DAILY /TN SMARTALPHA_SET_DATA_5 /TR %SET_DATA% /RI 0 /ST %SET_DATA_5_TIME_ST% /F
SCHTASKS /Create /SC DAILY /TN SMARTALPHA_SET_DATA_6 /TR %SET_DATA% /RI 0 /ST %SET_DATA_6_TIME_ST% /F
SCHTASKS /Create /SC DAILY /TN SMARTALPHA_SET_DATA_7 /TR %SET_DATA% /RI 0 /ST %SET_DATA_7_TIME_ST% /F
SCHTASKS /Create /SC DAILY /TN SMARTALPHA_SET_DATA_8 /TR %SET_DATA% /RI 0 /ST %SET_DATA_8_TIME_ST% /F
SCHTASKS /Create /SC DAILY /TN SMARTALPHA_SET_DATA_9 /TR %SET_DATA% /RI 0 /ST %SET_DATA_9_TIME_ST% /F
