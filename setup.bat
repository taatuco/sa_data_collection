...
SCHTASKS /Create /SC DAILY /TN SMARTALPHA_GET_DATA /TR %GET_DATA% /RI 0 /ST %GET_DATA_TIME_ST% /K /F
SCHTASKS /Create /SC DAILY /TN SMARTALPHA_GET_FORECAST /TR %GET_FRC% /RI 0 /ST %GET_FRC_TIME_ST% /K /F
SCHTASKS /Create /SC DAILY /TN SMARTALPHA_SET_DATA /TR %SET_DATA% /RI 0 /ST %SET_DATA_TIME_ST% /K /F
