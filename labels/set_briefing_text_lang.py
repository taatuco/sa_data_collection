...
_8_workdstocks_up_JPY_up_en = 'The Yen progressed by {day_percent} against the US dollar.'
_8_worldstocks_down_JPY_up_en = 'The Yen advanced by {day_percent} against the US dollar as investors seek refuge in the safe-haven currency.'
_9_gold_up_en = 'Gold benefited, up {day_percent}.'
_9_gold_down_en = 'Gold lost {day_percent}.'
_10_BTC_day_up_week_up_en = 'Bitcoin is posting some gains with upside at {day_percent} adding up to a {week_percent} since last week.'
_10_BTC_day_down_week_up_en = 'Bitcoin is posting some losses with {day_percent}, however, it remained in the upside for a week, up {week_percent}.'
_11_BTC_day_up_week_down_en = 'Bitcoin is posting some gains with {day_percent}, but still in the downside since a week, down {week_percent}.'
_11_BTC_day_down_week_down_en = 'Bitcoin is posting continuous losses down {day_percent} and {week_percent} since a week.'

sql = 'INSERT IGNORE INTO briefing'+\
'(lang,_1_worldstocks_day_up_week_down,_1_worldstocks_day_down_week_up,_2_worldstocks_day_up_week_up,_2_worldstocks_day_down_week_down,'+\
