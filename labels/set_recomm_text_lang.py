...
portf_descr_en = "As per the "+ get_product_name() +" proprietary algorithm, projected profit of up to {display_forecast} for every {account_minimum} {unit} invested is achievable within the next 7 days with the following allocation: {portf_recomm} The specified portfolio has achieved an aggregated profit/loss of {portf_last_price} {unit} in the last 12 months with as a reference a trading account of {account_minimum} {unit}."
